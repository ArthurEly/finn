<<<<<<< Updated upstream
create_project finn_vivado_stitch_proj /tmp/finn_dev_afely/vivado_stitch_proj_dhtzyv07 -part xc7a100tcsg324-1
set_msg_config -id {[BD 41-1753]} -suppress
set_property ip_repo_paths [list $::env(FINN_ROOT)/finn-rtllib/memstream /tmp/finn_dev_afely/code_gen_ipgen_StreamingFIFO_0_8t3x334l/project_StreamingFIFO_0/sol1/impl/verilog /tmp/finn_dev_afely/code_gen_ipgen_MatrixVectorActivation_0_f0j6xz0m/project_MatrixVectorActivation_0/sol1/impl/ip /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_je30yj1r /tmp/finn_dev_afely/code_gen_ipgen_MatrixVectorActivation_1_jg5_oz9e/project_MatrixVectorActivation_1/sol1/impl/ip /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_9juxsk5g /tmp/finn_dev_afely/code_gen_ipgen_MatrixVectorActivation_2_uc9yndjr/project_MatrixVectorActivation_2/sol1/impl/ip /tmp/finn_dev_afely/code_gen_ipgen_MatrixVectorActivation_3_s3xbtu86/project_MatrixVectorActivation_3/sol1/impl/ip] [current_project]
=======
create_project finn_vivado_stitch_proj /tmp/finn_dev_finn/vivado_stitch_proj_1ksl6d1r -part xc7a100tcsg324-1
set_msg_config -id {[BD 41-1753]} -suppress
set_property ip_repo_paths [list $::env(FINN_ROOT)/finn-rtllib/memstream /tmp/finn_dev_finn/code_gen_ipgen_StreamingFIFO_0_b8nd8hxw/project_StreamingFIFO_0/sol1/impl/verilog /tmp/finn_dev_finn/code_gen_ipgen_MatrixVectorActivation_0_i5bjxrsi/project_MatrixVectorActivation_0/sol1/impl/ip /tmp/finn_dev_finn/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_y5lismed /tmp/finn_dev_finn/code_gen_ipgen_MatrixVectorActivation_1_6836m_5s/project_MatrixVectorActivation_1/sol1/impl/ip /tmp/finn_dev_finn/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_pzy6oj_f /tmp/finn_dev_finn/code_gen_ipgen_MatrixVectorActivation_2_s1fh6ggp/project_MatrixVectorActivation_2/sol1/impl/ip /tmp/finn_dev_finn/code_gen_ipgen_MatrixVectorActivation_3_p9c_s79m/project_MatrixVectorActivation_3/sol1/impl/ip] [current_project]
>>>>>>> Stashed changes
update_ip_catalog
...
<<<<<<< Updated upstream
set_property -dict [list CONFIG.DEPTH {60} CONFIG.WIDTH {1280} CONFIG.INIT_FILE {/tmp/finn_dev_afely/code_gen_ipgen_MatrixVectorActivation_0_f0j6xz0m/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MatrixVectorActivation_0/MatrixVectorActivation_0_wstrm]
=======
set_property -dict [list CONFIG.DEPTH {60} CONFIG.WIDTH {1280} CONFIG.INIT_FILE {/tmp/finn_dev_finn/code_gen_ipgen_MatrixVectorActivation_0_i5bjxrsi/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MatrixVectorActivation_0/MatrixVectorActivation_0_wstrm]
>>>>>>> Stashed changes
...
save_bd_design
<<<<<<< Updated upstream
add_files -norecurse /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_je30yj1r/dwc_axi.sv
add_files -norecurse /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_je30yj1r/dwc.sv
add_files -norecurse /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_je30yj1r/StreamingDataWidthConverter_rtl_0.v
=======
add_files -norecurse /tmp/finn_dev_finn/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_y5lismed/dwc_axi.sv
add_files -norecurse /tmp/finn_dev_finn/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_y5lismed/dwc.sv
add_files -norecurse /tmp/finn_dev_finn/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_y5lismed/StreamingDataWidthConverter_rtl_0.v
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
set_property -dict [list CONFIG.DEPTH {64} CONFIG.WIDTH {128} CONFIG.INIT_FILE {/tmp/finn_dev_afely/code_gen_ipgen_MatrixVectorActivation_1_jg5_oz9e/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MatrixVectorActivation_1/MatrixVectorActivation_1_wstrm]
=======
set_property -dict [list CONFIG.DEPTH {64} CONFIG.WIDTH {128} CONFIG.INIT_FILE {/tmp/finn_dev_finn/code_gen_ipgen_MatrixVectorActivation_1_6836m_5s/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MatrixVectorActivation_1/MatrixVectorActivation_1_wstrm]
>>>>>>> Stashed changes
...
save_bd_design
<<<<<<< Updated upstream
add_files -norecurse /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_9juxsk5g/dwc_axi.sv
add_files -norecurse /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_9juxsk5g/dwc.sv
add_files -norecurse /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_9juxsk5g/StreamingDataWidthConverter_rtl_1.v
=======
add_files -norecurse /tmp/finn_dev_finn/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_pzy6oj_f/dwc_axi.sv
add_files -norecurse /tmp/finn_dev_finn/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_pzy6oj_f/dwc.sv
add_files -norecurse /tmp/finn_dev_finn/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_pzy6oj_f/StreamingDataWidthConverter_rtl_1.v
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
set_property -dict [list CONFIG.DEPTH {64} CONFIG.WIDTH {128} CONFIG.INIT_FILE {/tmp/finn_dev_afely/code_gen_ipgen_MatrixVectorActivation_2_uc9yndjr/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MatrixVectorActivation_2/MatrixVectorActivation_2_wstrm]
=======
set_property -dict [list CONFIG.DEPTH {64} CONFIG.WIDTH {128} CONFIG.INIT_FILE {/tmp/finn_dev_finn/code_gen_ipgen_MatrixVectorActivation_2_s1fh6ggp/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MatrixVectorActivation_2/MatrixVectorActivation_2_wstrm]
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
set_property -dict [list CONFIG.DEPTH {64} CONFIG.WIDTH {8} CONFIG.INIT_FILE {/tmp/finn_dev_afely/code_gen_ipgen_MatrixVectorActivation_3_s3xbtu86/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MatrixVectorActivation_3/MatrixVectorActivation_3_wstrm]
=======
set_property -dict [list CONFIG.DEPTH {64} CONFIG.WIDTH {8} CONFIG.INIT_FILE {/tmp/finn_dev_finn/code_gen_ipgen_MatrixVectorActivation_3_p9c_s79m/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MatrixVectorActivation_3/MatrixVectorActivation_3_wstrm]
>>>>>>> Stashed changes
...
save_bd_design
<<<<<<< Updated upstream
make_wrapper -files [get_files /tmp/finn_dev_afely/vivado_stitch_proj_dhtzyv07/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/finn_design.bd] -top
add_files -norecurse /tmp/finn_dev_afely/vivado_stitch_proj_dhtzyv07/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/hdl/finn_design_wrapper.v
set_property top finn_design_wrapper [current_fileset]
ipx::package_project -root_dir /tmp/finn_dev_afely/vivado_stitch_proj_dhtzyv07/ip -vendor xilinx_finn -library finn -taxonomy /UserIP -module finn_design -import_files
=======
make_wrapper -files [get_files /tmp/finn_dev_finn/vivado_stitch_proj_1ksl6d1r/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/finn_design.bd] -top
add_files -norecurse /tmp/finn_dev_finn/vivado_stitch_proj_1ksl6d1r/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/hdl/finn_design_wrapper.v
set_property top finn_design_wrapper [current_fileset]
ipx::package_project -root_dir /tmp/finn_dev_finn/vivado_stitch_proj_1ksl6d1r/ip -vendor xilinx_finn -library finn -taxonomy /UserIP -module finn_design -import_files
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
set fp [open /tmp/finn_dev_afely/vivado_stitch_proj_dhtzyv07/all_verilog_srcs.txt w]
=======
set fp [open /tmp/finn_dev_finn/vivado_stitch_proj_1ksl6d1r/all_verilog_srcs.txt w]
>>>>>>> Stashed changes

...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot finn_design xil_defaultlib.finn_design xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim finn_design -key {Behavioral:sim_1:Functional:finn_design} -tclbatch cmd.tcl -protoinst "protoinst_files/finn_design.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb finn_design.wdb xsim.dir libdpi.so)

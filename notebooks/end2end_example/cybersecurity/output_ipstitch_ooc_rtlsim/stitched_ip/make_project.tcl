create_project finn_vivado_stitch_proj /tmp/finn_dev_finn/vivado_stitch_proj_8v8vpjdq -part xc7a100tcsg324-1
set_msg_config -id {[BD 41-1753]} -suppress
set_property ip_repo_paths [list $::env(FINN_ROOT)/finn-rtllib/memstream /tmp/finn_dev_finn/code_gen_ipgen_StreamingFIFO_0_od7w2eda/project_StreamingFIFO_0/sol1/impl/verilog /tmp/finn_dev_finn/code_gen_ipgen_MatrixVectorActivation_0_777900uk/project_MatrixVectorActivation_0/sol1/impl/ip /tmp/finn_dev_finn/code_gen_ipgen_StreamingFIFO_1_asm60yqv/project_StreamingFIFO_1/sol1/impl/verilog /tmp/finn_dev_finn/code_gen_ipgen_MatrixVectorActivation_1_kbic1_4r/project_MatrixVectorActivation_1/sol1/impl/ip /tmp/finn_dev_finn/code_gen_ipgen_MatrixVectorActivation_2_jdsusk8l/project_MatrixVectorActivation_2/sol1/impl/ip /tmp/finn_dev_finn/code_gen_ipgen_MatrixVectorActivation_3_0radjse2/project_MatrixVectorActivation_3/sol1/impl/ip] [current_project]
update_ip_catalog
...
set_property -dict [list CONFIG.DEPTH {38400} CONFIG.WIDTH {8} CONFIG.INIT_FILE {/tmp/finn_dev_finn/code_gen_ipgen_MatrixVectorActivation_0_777900uk/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MatrixVectorActivation_0/MatrixVectorActivation_0_wstrm]
...
set_property -dict [list CONFIG.DEPTH {4096} CONFIG.WIDTH {8} CONFIG.INIT_FILE {/tmp/finn_dev_finn/code_gen_ipgen_MatrixVectorActivation_1_kbic1_4r/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MatrixVectorActivation_1/MatrixVectorActivation_1_wstrm]
...
set_property -dict [list CONFIG.DEPTH {4096} CONFIG.WIDTH {8} CONFIG.INIT_FILE {/tmp/finn_dev_finn/code_gen_ipgen_MatrixVectorActivation_2_jdsusk8l/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MatrixVectorActivation_2/MatrixVectorActivation_2_wstrm]
...
set_property -dict [list CONFIG.DEPTH {64} CONFIG.WIDTH {8} CONFIG.INIT_FILE {/tmp/finn_dev_finn/code_gen_ipgen_MatrixVectorActivation_3_0radjse2/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MatrixVectorActivation_3/MatrixVectorActivation_3_wstrm]
...
connect_bd_intf_net [get_bd_intf_pins MatrixVectorActivation_0/out_V] [get_bd_intf_pins StreamingFIFO_1/in0_V]
...
connect_bd_intf_net [get_bd_intf_pins StreamingFIFO_1/out_V] [get_bd_intf_pins MatrixVectorActivation_1/in0_V]
...
validate_bd_design
save_bd_design
make_wrapper -files [get_files /tmp/finn_dev_finn/vivado_stitch_proj_8v8vpjdq/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/finn_design.bd] -top
add_files -norecurse /tmp/finn_dev_finn/vivado_stitch_proj_8v8vpjdq/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/hdl/finn_design_wrapper.v
set_property top finn_design_wrapper [current_fileset]
ipx::package_project -root_dir /tmp/finn_dev_finn/vivado_stitch_proj_8v8vpjdq/ip -vendor xilinx_finn -library finn -taxonomy /UserIP -module finn_design -import_files
...
set fp [open /tmp/finn_dev_finn/vivado_stitch_proj_8v8vpjdq/all_verilog_srcs.txt w]

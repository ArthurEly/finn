create_project finn_vivado_stitch_proj /tmp/finn_dev_afely/vivado_stitch_proj_ltw45isy -part xc7a100tcsg324-1
set_msg_config -id {[BD 41-1753]} -suppress
set_property ip_repo_paths [list $::env(FINN_ROOT)/finn-rtllib/memstream /tmp/finn_dev_afely/code_gen_ipgen_StreamingFIFO_0_335mszvq/project_StreamingFIFO_0/sol1/impl/verilog /tmp/finn_dev_afely/code_gen_ipgen_MatrixVectorActivation_0_aouaxam1/project_MatrixVectorActivation_0/sol1/impl/ip /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_1p715uxm /tmp/finn_dev_afely/code_gen_ipgen_MatrixVectorActivation_1_4183k3o9/project_MatrixVectorActivation_1/sol1/impl/ip /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_1myzabmz /tmp/finn_dev_afely/code_gen_ipgen_MatrixVectorActivation_2_91m27s32/project_MatrixVectorActivation_2/sol1/impl/ip /tmp/finn_dev_afely/code_gen_ipgen_MatrixVectorActivation_3_j19xpsew/project_MatrixVectorActivation_3/sol1/impl/ip] [current_project]
update_ip_catalog
...
set_property -dict [list CONFIG.DEPTH {60} CONFIG.WIDTH {1280} CONFIG.INIT_FILE {/tmp/finn_dev_afely/code_gen_ipgen_MatrixVectorActivation_0_aouaxam1/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MatrixVectorActivation_0/MatrixVectorActivation_0_wstrm]
...
save_bd_design
add_files -norecurse /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_1p715uxm/dwc_axi.sv
add_files -norecurse /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_1p715uxm/dwc.sv
add_files -norecurse /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_1p715uxm/StreamingDataWidthConverter_rtl_0.v
...
set_property -dict [list CONFIG.DEPTH {64} CONFIG.WIDTH {128} CONFIG.INIT_FILE {/tmp/finn_dev_afely/code_gen_ipgen_MatrixVectorActivation_1_4183k3o9/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MatrixVectorActivation_1/MatrixVectorActivation_1_wstrm]
...
save_bd_design
add_files -norecurse /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_1myzabmz/dwc_axi.sv
add_files -norecurse /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_1myzabmz/dwc.sv
add_files -norecurse /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_1myzabmz/StreamingDataWidthConverter_rtl_1.v
...
set_property -dict [list CONFIG.DEPTH {64} CONFIG.WIDTH {128} CONFIG.INIT_FILE {/tmp/finn_dev_afely/code_gen_ipgen_MatrixVectorActivation_2_91m27s32/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MatrixVectorActivation_2/MatrixVectorActivation_2_wstrm]
...
set_property -dict [list CONFIG.DEPTH {64} CONFIG.WIDTH {8} CONFIG.INIT_FILE {/tmp/finn_dev_afely/code_gen_ipgen_MatrixVectorActivation_3_j19xpsew/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MatrixVectorActivation_3/MatrixVectorActivation_3_wstrm]
...
validate_bd_design
save_bd_design
make_wrapper -files [get_files /tmp/finn_dev_afely/vivado_stitch_proj_ltw45isy/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/finn_design.bd] -top
add_files -norecurse /tmp/finn_dev_afely/vivado_stitch_proj_ltw45isy/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/hdl/finn_design_wrapper.v
set_property top finn_design_wrapper [current_fileset]
ipx::package_project -root_dir /tmp/finn_dev_afely/vivado_stitch_proj_ltw45isy/ip -vendor xilinx_finn -library finn -taxonomy /UserIP -module finn_design -import_files
...
set fp [open /tmp/finn_dev_afely/vivado_stitch_proj_ltw45isy/all_verilog_srcs.txt w]

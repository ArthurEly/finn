...
HD_PWD='/home/artti/Desktop/finn/notebooks/sat6_cnn/T1-8bit/build_t1w8/stitched_ip/finn_vivado_stitch_proj.runs/finn_design_MatrixVectorActivation_2_0_synth_1'
cd "$HD_PWD"

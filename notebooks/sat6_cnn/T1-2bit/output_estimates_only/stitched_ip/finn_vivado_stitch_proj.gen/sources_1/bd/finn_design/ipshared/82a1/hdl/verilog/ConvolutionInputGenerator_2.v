...
(* CORE_GENERATION_INFO="ConvolutionInputGenerator_2_ConvolutionInputGenerator_2,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=9.258000,HLS_SYN_LAT=1398,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=543,HLS_SYN_LUT=2183,HLS_VERSION=2023_2}" *)
...
ConvolutionInputGenerator_2_ConvolutionInputGenerator_kernel_stride grp_ConvolutionInputGenerator_kernel_stride_fu_28(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),

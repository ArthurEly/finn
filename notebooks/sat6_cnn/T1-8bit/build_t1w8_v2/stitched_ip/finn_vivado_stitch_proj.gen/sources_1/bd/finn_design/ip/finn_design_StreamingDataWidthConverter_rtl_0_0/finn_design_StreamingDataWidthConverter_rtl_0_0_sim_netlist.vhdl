...
-- Date        : Tue Mar 12 01:57:22 2024
-- Host        : artti-desktop running 64-bit Ubuntu 22.04.4 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/artti/Desktop/finn/notebooks/sat6_cnn/T1-8bit/build_t1w8_v2/stitched_ip/finn_vivado_stitch_proj.gen/sources_1/bd/finn_design/ip/finn_design_StreamingDataWidthConverter_rtl_0_0/finn_design_StreamingDataWidthConverter_rtl_0_0_sim_netlist.vhdl
...
entity finn_design_StreamingDataWidthConverter_rtl_0_0_dwc is
  port (
    ...
    out_V_TDATA : out STD_LOGIC_VECTOR ( 287 downto 0 );
...
architecture STRUCTURE of finn_design_StreamingDataWidthConverter_rtl_0_0_dwc is
  ...
  signal \^out_v_tdata\ : STD_LOGIC_VECTOR ( 287 downto 0 );
  ...
  attribute SOFT_HLUTNM of \genUp.ACnt[6]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \genUp.ADat[35][0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \genUp.ADat[35][1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \genUp.ADat[35][2]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \genUp.ADat[35][3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \genUp.ADat[35][4]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \genUp.ADat[35][5]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \genUp.ADat[35][6]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \genUp.ADat[35][7]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \genUp.BRdy_i_2\ : label is "soft_lutpair0";
begin
  out_V_TDATA(287 downto 0) <= \^out_v_tdata\(287 downto 0);
...
\genUp.ACnt[6]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFEEFE"
    )
        port map (
...
\genUp.ADat[35][0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\genUp.ADat[35][1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\genUp.ADat[35][2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\genUp.ADat[35][3]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\genUp.ADat[35][4]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\genUp.ADat[35][5]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\genUp.ADat[35][6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\genUp.ADat[35][7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"DD0D"
    )
        port map (
...
\genUp.ADat[35][7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
architecture STRUCTURE of finn_design_StreamingDataWidthConverter_rtl_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of out_V_TDATA : signal is "XIL_INTERFACENAME out_V, TDATA_NUM_BYTES 36, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN finn_design_ap_clk_0, LAYERED_METADATA undef, INSERT_VIP 0";
begin

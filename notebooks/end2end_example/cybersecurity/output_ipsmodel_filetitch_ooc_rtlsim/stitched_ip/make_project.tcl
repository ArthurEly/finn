create_project finn_vivado_stitch_proj /tmp/finn_dev_afely/vivado_stitch_proj_vxb3jb3z -part xc7a100tcsg324-1
set_msg_config -id {[BD 41-1753]} -suppress
set_property ip_repo_paths [list $::env(FINN_ROOT)/finn-rtllib/memstream /tmp/finn_dev_afely/code_gen_ipgen_StreamingFIFO_0_yjq7ioh0/project_StreamingFIFO_0/sol1/impl/verilog /tmp/finn_dev_afely/code_gen_ipgen_MatrixVectorActivation_0_pvx9a_ey/project_MatrixVectorActivation_0/sol1/impl/ip /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_m5d155um /tmp/finn_dev_afely/code_gen_ipgen_MatrixVectorActivation_1_3ydl9zqa/project_MatrixVectorActivation_1/sol1/impl/ip /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_4okjhpic /tmp/finn_dev_afely/code_gen_ipgen_MatrixVectorActivation_2_0fvb0wc4/project_MatrixVectorActivation_2/sol1/impl/ip /tmp/finn_dev_afely/code_gen_ipgen_MatrixVectorActivation_3_iaug875i/project_MatrixVectorActivation_3/sol1/impl/ip] [current_project]
update_ip_catalog
...
add_files -norecurse /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_m5d155um/dwc_axi.sv
add_files -norecurse /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_m5d155um/dwc.sv
add_files -norecurse /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_m5d155um/StreamingDataWidthConverter_rtl_0.v
...
add_files -norecurse /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_4okjhpic/dwc_axi.sv
add_files -norecurse /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_4okjhpic/dwc.sv
add_files -norecurse /tmp/finn_dev_afely/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_4okjhpic/StreamingDataWidthConverter_rtl_1.v
...
create_bd_cell -type ip -vlnv xilinx.com:hls:MatrixVectorActivation_3:1.0 MatrixVectorActivation_3
...
validate_bd_design
save_bd_design
make_wrapper -files [get_files /tmp/finn_dev_afely/vivado_stitch_proj_vxb3jb3z/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/finn_design.bd] -top
add_files -norecurse /tmp/finn_dev_afely/vivado_stitch_proj_vxb3jb3z/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/hdl/finn_design_wrapper.v
set_property top finn_design_wrapper [current_fileset]
ipx::package_project -root_dir /tmp/finn_dev_afely/vivado_stitch_proj_vxb3jb3z/ip -vendor xilinx_finn -library finn -taxonomy /UserIP -module finn_design -import_files
...
set fp [open /tmp/finn_dev_afely/vivado_stitch_proj_vxb3jb3z/all_verilog_srcs.txt w]

...
module ConvolutionInputGenerator_2_ConvolutionInputGenerator_kernel_stride (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [2:0] trunc_ln514_1_fu_548_p1;
wire   [3:0] shl_ln1_fu_552_p3;
wire   [3:0] trunc_ln514_fu_544_p1;
wire   [3:0] add_ln514_fu_560_p2;
...
ConvolutionInputGenerator_2_ConvolutionInputGenerator_kernel_stride_inputBuf_RAM_S2P_LUTRAM_1R1W #(
    .DataWidth( 8 ),
    .AddressRange( 80 ),
    .AddressWidth( 7 ))
inputBuf_U(
...
ConvolutionInputGenerator_2_sparsemux_11_3_8_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .CASE0( 3'h0 ),
    .din0_WIDTH( 8 ),
...
always @ (*) begin
    ap_condition_861 = ((ap_start_int == 1'b1) & (icmp_ln478_fu_466_p2 == 1'd0) & (1'b1 == ap_CS_iter0_fsm_state1));
end

always @ (*) begin
    ap_condition_926 = ((ap_start_int == 1'b1) & (trunc_ln475_fu_485_p1 == 3'd1) & (icmp_ln478_fu_466_p2 == 1'd0) & (1'b1 == ap_CS_iter0_fsm_state1));
end

always @ (*) begin
    ap_condition_930 = ((ap_start_int == 1'b1) & (trunc_ln475_fu_485_p1 == 3'd2) & (icmp_ln478_fu_466_p2 == 1'd0) & (1'b1 == ap_CS_iter0_fsm_state1));
end

always @ (*) begin
    ap_condition_934 = ((ap_start_int == 1'b1) & (trunc_ln475_fu_485_p1 == 3'd3) & (icmp_ln478_fu_466_p2 == 1'd0) & (1'b1 == ap_CS_iter0_fsm_state1));
end

always @ (*) begin
    ap_condition_941 = (~(trunc_ln475_fu_485_p1 == 3'd0) & ~(trunc_ln475_fu_485_p1 == 3'd1) & ~(trunc_ln475_fu_485_p1 == 3'd2) & ~(trunc_ln475_fu_485_p1 == 3'd3) & (ap_start_int == 1'b1) & (icmp_ln478_fu_466_p2 == 1'd0) & (1'b1 == ap_CS_iter0_fsm_state1));
end

always @ (*) begin
    ap_condition_945 = ((ap_start_int == 1'b1) & (trunc_ln475_fu_485_p1 == 3'd0) & (icmp_ln478_fu_466_p2 == 1'd0) & (1'b1 == ap_CS_iter0_fsm_state1));
end
...
assign grp_fu_354_p2 = ((grp_fu_348_p2 == 32'd80) ? 1'b1 : 1'b0);
...
assign i_2_fu_472_p2 = (ap_sig_allocacmp_i_1 + 11'd1);

assign icmp_ln478_fu_466_p2 = ((ap_sig_allocacmp_i_1 == 11'd1392) ? 1'b1 : 1'b0);

assign icmp_ln480_fu_489_p2 = ((ap_sig_allocacmp_inp_1 < 32'd240) ? 1'b1 : 1'b0);

assign icmp_ln499_1_fu_501_p2 = ((ap_sig_allocacmp_read_block_3 == 32'd10) ? 1'b1 : 1'b0);
...
assign icmp_ln518_fu_586_p2 = ((count_simd_1_fu_580_p2 == 32'd8) ? 1'b1 : 1'b0);
...
assign icmp_ln527_fu_658_p2 = ((ofm_x_1_fu_652_p2 == 32'd4) ? 1'b1 : 1'b0);

assign icmp_ln527_reg_1192_pp0_iter0_reg = icmp_ln527_reg_1192;

assign icmp_ln530_fu_693_p2 = ((ofm_y_1_fu_687_p2 == 32'd4) ? 1'b1 : 1'b0);

assign icmp_ln539_1_fu_746_p2 = ((ap_sig_allocacmp_read_block_3 < 32'd10) ? 1'b1 : 1'b0);

assign icmp_ln539_fu_740_p2 = ((ap_sig_allocacmp_counter_internal_block_1 < 32'd159) ? 1'b1 : 1'b0);
...
assign shl_ln514_1_fu_566_p3 = {{add_ln514_fu_560_p2}, {3'd0}};
...
assign trunc_ln514_1_fu_548_p1 = ap_sig_allocacmp_ofm_x_load[2:0];

assign trunc_ln514_fu_544_p1 = ap_sig_allocacmp_k_x_load[3:0];
...
endmodule //ConvolutionInputGenerator_2_ConvolutionInputGenerator_kernel_stride
